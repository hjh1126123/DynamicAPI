...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl='urn:schemas-microsoft-com:xslt'>
    ...
    <xsl:template match="Property">
        <xsl:if test="@Name!='Date' and @Name!='LogNumber' and @Name!='Solution'">
        <tr><td nowrap="1"><b><xsl:value-of select="@Name"/>: </b><xsl:value-of select="@Value"/></td></tr>
        </xsl:if>
    </xsl:template>

    <xsl:template match="LinqUpgradeLog">
        <html>
            <head>
                <META HTTP-EQUIV="Content-Type" content="text/html; charset=utf-8" />
                <link rel="stylesheet" href="_LinqUpgradeReport_Files\LinqUpgradeReport.css" />
                ...
                <script language="javascript">
                    ...
                    function changepic() {
                        ...
                        if (check.lastIndexOf("linqupgradereport_plus.gif") != -1)
                        {
                            uMe.src = "_LinqUpgradeReport_Files/LinqUpgradeReport_Minus.gif"
                        }
                        else
                        {
                            uMe.src = "_LinqUpgradeReport_Files/LinqUpgradeReport_Plus.gif"
                        }
                    }
                </script>
            </head>
            <body topmargin="0" leftmargin="0" rightmargin="0" onclick="outliner();">
                ...
                <p><span class="note">
                <b _locID="TimeOfConversion">Time of Conversion:</b>&#32;&#32;<xsl:value-of select="Properties/Property[@Name='Date']/@Value"/><br/>
                </span></p>
                    ...
                    <Events>
                        <xsl:for-each select="Event">
                            ...
                            <Event>
                                ...
                                <xsl:attribute name="Solution"><xsl:value-of select="/LinqUpgradeLog/Properties/Property[@Name='Solution']/@Value"/> </xsl:attribute> 
