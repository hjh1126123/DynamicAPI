...
// Code is generated on: 2019/4/19 17:46:19
//
...
namespace EntityLocal
{
    ...
    public partial class BGroup : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"gid", Storage = "_Gid", CanBeNull = false, DbType = "VARCHAR NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public string Gid
        {
            get
            {
    ...
    public partial class BActive : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"aid", Storage = "_Aid", CanBeNull = false, DbType = "VARCHAR NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public string Aid
        {
            get
            {
